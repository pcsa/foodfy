...
class ChefsController {
    ...
    async post(req, res) {
        try {
            ...
            return res.render('admin/chefs/create', {
                error: 'Houve um erro ao criar um chef. Por favor, tente novamente.',
                chef: req.body,
            });
        }
    }
    ...
    async edit(req, res) {
        try {
            ...
            return res.status(errorData.status).json({
                error: 'Houve um erro durante o render da view de edição um chef',
                errorData,
            });
        }
    }
    ...
    async put(req, res) {
        try {
            ...
            return res.render('admin/chefs/edit', {
                error: 'Houve um erro ao editar o chef. Por favor, tente novamente',
                chef: req.body,
            });
        }
    }
    ...
    async delete(req, res) {
        try {
            ...
            return res.render('admin/chefs/edit', {
                error: 'Houve um erro ao deletar o chef. Por favor, tente novamente',
                chef: req.body,
            });
        }
    }
